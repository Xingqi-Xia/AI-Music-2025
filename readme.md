...
1. 安装Python。前往Python官网(https://www.python.org/downloads/)，点击页面上最显眼的"Download Python 3.xx.x"按钮，随后将页面滑到底，下载Windows Installer (64-bit)文件。双击运行该安装包进行安装。安装时全部选择默认选项，但是一定要勾上“将Python添加到环境变量”的选框。
