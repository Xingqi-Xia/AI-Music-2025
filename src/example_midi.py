...
from MusicRep import MelodySequence, Synthesizer, SineStrategy, fixGrid, StringStrategy, MusicConfig
import os
# 储存位置
...
# 生成一个随机旋律序列
melody = MelodySequence.from_random(seed=114514)
...
melody.save_staff(os.path.join(SAVE_FOLDER, "random_melody.png"))
